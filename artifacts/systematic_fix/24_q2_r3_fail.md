...
- `Q400` 연면적이 가장 큰 공장 이름  
  gold=`A24=르노코리아자동차(주); A4=부산광역시 강서구 신호동; A14=74,540.74` reason=`scalar-mismatch hits=1 gold=[24.0, 4.0, 14.0, 74540.74]` route=`semantic_plan_rank`
...
- `Q423` 평균 지상층  
  gold=`n=405; avg_fl=18.2667` reason=`scalar-mismatch hits=1 gold=[405.0, 18.2667]` route=`semantic_plan_aggregate`
...
- `Q474` 그중 건물높이 15m 이상만  
  gold=`313채` reason=`count-mismatch gold=313 pred=[100.0, 1.0, 188.0, -14.0, 16.8, 2.0]` route=`semantic_plan_list`
