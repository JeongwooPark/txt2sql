...
- `Q208` 기장군 용적율이 0보다 크고 80% 미만인 공장 채수  
  gold=`593채` reason=`count-mismatch gold=593 pred=[477.0, 477.0]` route=`semantic_plan_count`
...
- `Q465` 구서동 2000년 이후 사용승인 공동주택 채수  
  gold=`273채` reason=`count-mismatch gold=273 pred=[2000.0, 466.0, 466.0]` route=`d198_attr_count`
- `Q488` 가장 높은 건물 이름  
  gold=`A24=대림쌍용강변타운; A16=82.4; A26=29; A4=부산광역시 북구 화명동` reason=`name-missing 대림쌍용강변타운` route=`building_rank_높이`
...
- `Q438` 그중 용적율 200% 이상만  
  gold=`769채` reason=`count-mismatch gold=769 pred=[100.0, 1.0, 566.0, -6.0, 2.0, 1405.0]` route=`semantic_plan_list`
- `Q466` 그중 높이 40m 이상만  
