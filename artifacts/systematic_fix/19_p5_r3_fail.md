...
- 시각: 2026-08-25 03:11:57
- 현재: 7/38 (18.4%)
- 기준선: 198/500 (39.6%)

## 구조 원인 빈도

- `PREDICATE_DROPPED`: 21
- `RANGE_BOUND_DROPPED`: 4
...
- `Q474` 그중 건물높이 15m 이상만  
  gold=`313채` reason=`count-mismatch gold=313 pred=[100.0, 1.0, 900.0, -3.0, 20.4, 2.0]` route=`semantic_plan_list`
