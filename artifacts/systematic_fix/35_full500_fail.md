...
- 시각: 2026-08-25 12:07:33
- 현재: 379/500 (75.8%)
- 기준선: 198/500 (39.6%)

## 구조 원인 빈도

- `PREDICATE_DROPPED`: 54
- `ENTITY_SELECTION_ERROR`: 52
- `FOLLOWUP_CONTEXT_LOST`: 14
- `RANGE_BOUND_DROPPED`: 11
...
- `N016` 법정동명과 행정동명의 차이가 뭐야?  
  gold=`diff=법정동명(A4)은 토지·건물 대장 주소, 행정동명(ADM_NM)은 센서스 행정구역 경계` reason=`engine-fail:plan generation failed` route=`None`
- `N028` 광안동의 철근콘크리트 구조물은?  
  gold=`1. A24=수영역 삼정그린코아 더시티, A4=부산광역시 수영구 광안동, A5=98-1, A11=철근콘크리트구조, A16=62.09, A14=32,799.265 / 2. A24=광안역 성원상떼빌, A4=부산광역시 수영구 광안동, A5=143-1, A11=철근콘크리트구조, A16=67.91, A14=31,682.859 / 3. A24=없음, A4=부산광역시 수영구 광안동, A5=744-32, A11=철근콘크리트구조, A16=77.4, A14=29,271.58 / 4. A24=광안동삼정그린코아아파트, A4=부산광역시 수영구 광안동, A5=172-1, A11=철근콘크리트구조, A16=65.3, A14=27,570.733 / 5. A24=광원아파트, A4=부산광역시 수영구 광안동, A5=526-1, A11=철근콘크리트구조, A16=0, A14=25,535.98 / 6. A24=광안지웰 에스테이트, A4=부산광역시 수영구 광안동, A5=201-5, A11=철근콘크리트구조, A16=59.9, A14=24,349.92 / 7. A24=비치-그린아파트, A4=부산광역시 수영구 광안동, A5=529, A11=철근콘크리트구조, A16=52.35, A14=22,710.9 / 8. A24=부산광안대우아이빌, A4=부산광역시 수영구 광안동, A5=193-4, A11=철근콘크리트구조, A16=74.45, A14=21,779.4 / 9. A24=태평양하이츠, A4=부산광역시 수영구 광안동, A5=182-4, A11=철근콘크리트구조, A16=42.7, A14=20,669.206 / 10. A24=광안동롯데골드로즈, A4=부산광역시 수영구 광안동, A5=99-5, A11=철근콘크리트구조, A16=60.1, A14=19,028.74 / 11. A24=광안동일스위트아파트, A4=부산광역시 수영구 광안동, A5=1069-3, A11=철근콘크리트구조, A16=51.3, A14=18,428.1672 / 12. A24=호텔아쿠아펠리스, A4=부산광역시 수영구 광안동, A5=192-5, A11=철근콘크리트구조, A16=71.2, A14=18,228.2 / 13. A24=빌리브광안에이파크오션, A4=부산광역시 수영구 광안동, A5=200-6, A11=철근콘크리트구조, A16=59.9, A14=17,200.11 / 14. A24=호메르스관광호텔, A4=부산광역시 수영구 광안동, A5=193-1, A11=철근콘크리트구조, A16=73.8, A14=16,992.61 / 15. A24=비치-그린아파트, A4=부산광역시 수영구 광안동, A5=529, A11=철근콘크리트구조, A16=60.4, A14=16,179.74 외 5건` reason=`engine-fail:plan generation failed` route=`None`
- `N029` 엘시티의 높이와 층수는?  
  gold=`1. A24=중동 18290000 숙박시설 (주식회사엘시티피이에프브이), A25=랜드마크타워동, A4=부산광역시 해운대구 중동, A5=1829, A16=411.6, A26=101, A14=249,374.4587 / 2. A24=엘시티, A25=타워에이동, A4=부산광역시 해운대구 중동, A5=1829, A16=339.1, A26=85, A14=145,181.8812 / 3. A24=엘시티, A25=타워비동, A4=부산광역시 해운대구 중동, A5=1829, A16=333.1, A26=85, A14=145,181.8812 / 4. A24=르씨엘시티, A25=없음, A4=부산광역시 동래구 온천동, A5=1248-8, A16=57, A26=20, A14=4,220.66 / 5. A24=엘시티, A25=포디움동, A4=부산광역시 해운대구 중동, A5=1829, A16=43, A26=6, A14=121,396.5881` reason=`engine-fail:plan generation failed` route=`None`
- `N063` 광안동에서 연면적이 가장 큰 숙박시설은?  
  gold=`A24=호텔아쿠아펠리스; A4=부산광역시 수영구 광안동; A5=192-5; A14=18,228.2; A16=71.2` reason=`engine-fail:P06` route=`None`
- `N064` 그 건물 높이는?  
  gold=`height_m=71.2; A24=호텔아쿠아펠리스; A5=192-5` reason=`engine-fail:plan generation failed` route=`None`
- `N065` 남구에서 건물면적이 가장 큰 공동주택은?  
  gold=`A24=GS하이츠자이; A4=부산광역시 남구 용호동; A5=197; A12=30,636.6549; A14=103,795.1908` reason=`engine-fail:P06` route=`None`
- `N066` 지번 알려줘  
...
- `N069` 엘시티랑 엘크루 블루오션 중에 더 높은 건물은?  
  gold=`name=중동 18290000 숙박시설 (주식회사엘시티피이에프브이); height_m=411.6 | name=엘시티, height_m=339.1 / name=르씨엘시티, height_m=57 / name=엘크루 블루오션, height_m=35.45` reason=`engine-fail:plan generation failed` route=`None`
...
- `Q284` 우동과 교차하는 기초구역 개수와 그 중 면적 최대값  
  gold=`n=30; max_ar=6.2449` reason=`engine-fail:- 기초구역 공간 질의는 ST_Intersects/ST_Within/ST_DWithin을 써야 합니다.` route=`None`
- `Q390` 그중 2000년 이후 사용승인만  
  gold=`265채` reason=`engine-fail:count_row_count` route=`None`
- `Q402` 그중 2000년 이후 사용승인만  
  gold=`248채` reason=`engine-fail:count_row_count` route=`None`
- `Q403` 그 건물들 평균 높이  
...
- `Q407` 그 건물들 지하층이 있는 것은 몇 채야?  
  gold=`14채` reason=`engine-fail:P06` route=`None`
- `Q426` 그중 사용승인 2000년 이후만  
  gold=`320채` reason=`count-mismatch gold=320 pred=[380.0, 380.0]` route=`semantic_plan_count`
- `Q446` 그중 높이 15m 이상만  
  gold=`50채` reason=`count-mismatch gold=50 pred=[100.0, 1.0, 1041.0, -1.0, 17.0, 2.0]` route=`semantic_plan_list`
...
- `Q215` 강서구 건폐율 10% 미만이면서 연면적 3000㎡ 이상인 공장 채수  
  gold=`9채` reason=`count-mismatch gold=9 pred=[182.0, 182.0]` route=`semantic_plan_count`
...
- `Q181` 기장군 공동주택을 제외하고 높이 25m 이상인 건물 용도 상위 8개  
  gold=`1. usage=제1종근린생활시설, n=43 / 2. usage=업무시설, n=22 / 3. usage=숙박시설, n=20 / 4. usage=제2종근린생활시설, n=18 / 5. usage=의료시설, n=5 / 6. usage=공장, n=5 / 7. usage=자동차관련시설, n=5 / 8. usage=운동시설, n=4` reason=`engine-fail:missing_output` route=`None`
...
- `Q327` 동래구 명륜동 오피스텔 또는 사무소(세부용도) 채수  
  gold=`81채` reason=`engine-fail:slot_below_threshold:fields` route=`None`
