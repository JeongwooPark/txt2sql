...
- 시각: 2026-08-25 08:00:36
- 현재: 10/35 (28.6%)
- 기준선: 198/500 (39.6%)

## 구조 원인 빈도

- `PREDICATE_DROPPED`: 19
...
- `Q160` 영도구에서 단독주택이 아니고 벽돌·블록구조도 아닌 건물 중 연면적 1000㎡ 이상 채수  
  gold=`805채` reason=`count-mismatch gold=805 pred=[807.0, 807.0]` route=`semantic_plan_count`
...
- `Q358` 금정구 단독주택 경과 40년 이상 vs 10년 미만 채수  
  gold=`old40=6,495; young10=327` reason=`compare-num-missing` route=`building_age_count`
