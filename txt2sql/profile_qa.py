...
from txt2sql.answer import emit_text_chunks, narrate_building_profile
...
def is_profile_question(question: str) -> bool:
    ...
    from txt2sql.meta_qa import _asks_dataset_summary, _named_dataset_question
    ...
    from txt2sql.rank_compare_qa import is_rank_compare_question
    ...
    *,
    ...
    if place:
        ...
        if is_locality(place):
            from txt2sql.clarify_qa import _lookup_admin_dong, _lookup_places
