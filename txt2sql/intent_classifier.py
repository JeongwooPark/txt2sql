...
from txt2sql.guide_qa import _is_coverage_question, try_guide
from txt2sql.meta_qa import is_metadata_question
from txt2sql.profile_qa import is_profile_question, is_usage_overview_question
...
def _asks_catalog_safe(q: str) -> bool:
    from txt2sql.meta_qa import _asks_catalog
