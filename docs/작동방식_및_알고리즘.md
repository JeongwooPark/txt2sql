...
이 문서는 **0.2.2 코드가 지금 어떻게 도는지**를 시나리오로 설명하는 쪽에 맞춰 두었다. `SEMANTIC_PLAN_MODE` 기본값은 `hybrid`이다. 실패 시 RAG로 내려간다. 적용·롤백은 `docs/implementation/sqp_v11_migration.md`, `docs/implementation/sqp_v11_rollback.md`를 본다.
